...
def create_app():
    ...
    # v4.5: each RTMP output may inherit the channel source or select its own Library video
    # or external URL. Source overrides apply only to manual runs; schedules keep their media.
